...
extern "C" void apatb_top_hw(volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_B) {
    ...
    string AESL_num;
{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          if (i > 0) {((char*)__xlx_apatb_param_B)[0*4+0] = B_pc_buffer[0].range(7, 0).to_int64();
((char*)__xlx_apatb_param_B)[0*4+1] = B_pc_buffer[0].range(15, 8).to_int64();
((char*)__xlx_apatb_param_B)[0*4+2] = B_pc_buffer[0].range(23, 16).to_int64();
((char*)__xlx_apatb_param_B)[0*4+3] = B_pc_buffer[0].range(31, 24).to_int64();
}
        } // end transaction
      } // end file is good
...
top_hw_stub_wrapper(__xlx_apatb_param_A, __xlx_apatb_param_B);
