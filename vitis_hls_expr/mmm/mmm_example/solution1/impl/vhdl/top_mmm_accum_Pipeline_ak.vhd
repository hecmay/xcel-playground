...
entity top_mmm_accum_Pipeline_ak is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of top_mmm_accum_Pipeline_ak is 
...
attribute shreg_extract : string;
    ...
    signal trunc_ln55_1_fu_234_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln55_1_reg_320 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_pp0_stage1 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage1 : signal is "none";
    signal ap_block_state2_pp0_stage1_iter0 : BOOLEAN;
    signal ap_block_state18_pp0_stage1_iter1 : BOOLEAN;
    signal ap_block_pp0_stage1_11001 : BOOLEAN;
    signal trunc_ln55_2_fu_238_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln55_2_reg_325 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_1_reg_330 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_2_reg_335 : STD_LOGIC_VECTOR (31 downto 0);
    signal bitcast_ln55_fu_262_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_pp0_stage2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage2 : signal is "none";
    signal ap_block_state3_pp0_stage2_iter0 : BOOLEAN;
    signal ap_block_state19_pp0_stage2_iter1 : BOOLEAN;
    signal ap_block_pp0_stage2_11001 : BOOLEAN;
    signal bitcast_ln55_1_fu_266_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal bitcast_ln55_2_fu_270_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_pp0_stage3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage3 : signal is "none";
    signal ap_block_state4_pp0_stage3_iter0 : BOOLEAN;
    signal ap_block_state20_pp0_stage3_iter1 : BOOLEAN;
    signal ap_block_pp0_stage3_11001 : BOOLEAN;
    signal bitcast_ln55_3_fu_274_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal accum_fu_72 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_sig_allocacmp_accum_load : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage7 : BOOLEAN;
    signal ap_loop_init : STD_LOGIC;
    signal k_fu_76 : STD_LOGIC_VECTOR (8 downto 0);
    signal add_ln53_fu_223_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_sig_allocacmp_k_3 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal tmp_3_fu_189_p4 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_4_fu_204_p3 : STD_LOGIC_VECTOR (14 downto 0);
    signal zext_ln49_cast_fu_144_p1 : STD_LOGIC_VECTOR (14 downto 0);
    signal add_ln55_fu_212_p2 : STD_LOGIC_VECTOR (14 downto 0);
...
begin
    ...
    accum_fu_72_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                accum_fu_72 <= ap_const_lv32_0;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_reg_306 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage7_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage7))) then
                mul_1_reg_370 <= grp_fu_282_p_dout0;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_reg_306 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage6_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage6))) then
                mul_reg_360 <= grp_fu_282_p_dout0;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_reg_306 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then
                tmp_1_reg_330 <= A_q0(63 downto 32);
                tmp_2_reg_335 <= B_q0(63 downto 32);
                trunc_ln55_1_reg_320 <= trunc_ln55_1_fu_234_p1;
                trunc_ln55_2_reg_325 <= trunc_ln55_2_fu_238_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_reg_306 <= ap_sig_allocacmp_k_3(8 downto 8);
            end if;
        end if;
    end process;
    ...
    A_address0 <= zext_ln55_fu_199_p1(15 - 1 downto 0);
    ...
    B_address0 <= zext_ln55_1_fu_218_p1(15 - 1 downto 0);
    ...
    accum_out <= accum_fu_72;

    accum_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage7, tmp_reg_306, ap_block_pp0_stage7_11001)
    begin
    ...
    add_ln53_fu_223_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_k_3) + unsigned(ap_const_lv9_2));
    add_ln55_fu_212_p2 <= std_logic_vector(unsigned(tmp_4_fu_204_p3) + unsigned(zext_ln49_cast_fu_144_p1));
    ...
    ap_sig_allocacmp_accum_load_assign_proc : process(ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage7, reg_139, accum_fu_72, ap_block_pp0_stage7)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage7) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage7))) then 
            ap_sig_allocacmp_accum_load <= reg_139;
        else 
            ap_sig_allocacmp_accum_load <= accum_fu_72;
        end if; 
    end process;


    ap_sig_allocacmp_k_3_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, k_fu_76)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_sig_allocacmp_k_3 <= ap_const_lv9_0;
        else 
            ap_sig_allocacmp_k_3 <= k_fu_76;
        end if; 
    end process;

    bitcast_ln55_1_fu_266_p1 <= trunc_ln55_2_reg_325;
    bitcast_ln55_2_fu_270_p1 <= tmp_1_reg_330;
    bitcast_ln55_3_fu_274_p1 <= tmp_2_reg_335;
    bitcast_ln55_fu_262_p1 <= trunc_ln55_1_reg_320;

    grp_fu_131_p0_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage7, ap_CS_fsm_pp0_stage15, reg_139, ap_sig_allocacmp_accum_load, ap_block_pp0_stage7, ap_block_pp0_stage15)
    begin
        if ((ap_enable_reg_pp0_iter0 = ap_const_logic_1)) then
            if (((ap_const_boolean_0 = ap_block_pp0_stage15) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage15))) then 
                ...
                grp_fu_131_p0 <= ap_sig_allocacmp_accum_load;
            else 
    ...
    grp_fu_135_p0_assign_proc : process(ap_enable_reg_pp0_iter0, bitcast_ln55_fu_262_p1, ap_CS_fsm_pp0_stage2, bitcast_ln55_2_fu_270_p1, ap_CS_fsm_pp0_stage3, ap_block_pp0_stage2, ap_block_pp0_stage3)
    begin
        if ((ap_enable_reg_pp0_iter0 = ap_const_logic_1)) then
            if (((ap_const_boolean_0 = ap_block_pp0_stage3) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3))) then 
                grp_fu_135_p0 <= bitcast_ln55_2_fu_270_p1;
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
                grp_fu_135_p0 <= bitcast_ln55_fu_262_p1;
            else 
    ...
    grp_fu_135_p1_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage2, bitcast_ln55_1_fu_266_p1, ap_CS_fsm_pp0_stage3, bitcast_ln55_3_fu_274_p1, ap_block_pp0_stage2, ap_block_pp0_stage3)
    begin
        if ((ap_enable_reg_pp0_iter0 = ap_const_logic_1)) then
            if (((ap_const_boolean_0 = ap_block_pp0_stage3) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3))) then 
                grp_fu_135_p1 <= bitcast_ln55_3_fu_274_p1;
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
                grp_fu_135_p1 <= bitcast_ln55_1_fu_266_p1;
            else 
    ...
    grp_fu_282_p_din0 <= grp_fu_135_p0;
    grp_fu_282_p_din1 <= grp_fu_135_p1;
    grp_fu_93_p_ce <= ap_const_logic_1;
    grp_fu_93_p_din0 <= grp_fu_131_p0;
    grp_fu_93_p_din1 <= grp_fu_131_p1;
    grp_fu_93_p_opcode <= ap_const_lv2_0;
    lshr_ln_fu_169_p4 <= ap_sig_allocacmp_k_3(7 downto 1);
    tmp_3_fu_189_p4 <= ((tmp_s_fu_179_p4 & trunc_ln55) & lshr_ln_fu_169_p4);
    tmp_4_fu_204_p3 <= (lshr_ln_fu_169_p4 & ap_const_lv8_0);
    tmp_fu_161_p3 <= ap_sig_allocacmp_k_3(8 downto 8);
    tmp_s_fu_179_p4 <= select_ln48_1(8 downto 1);
    trunc_ln55_1_fu_234_p1 <= A_q0(32 - 1 downto 0);
    trunc_ln55_2_fu_238_p1 <= B_q0(32 - 1 downto 0);
    zext_ln49_cast_fu_144_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln49),15));
    zext_ln55_1_fu_218_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln55_fu_212_p2),64));
    zext_ln55_fu_199_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_3_fu_189_p4),64));
end behav;
