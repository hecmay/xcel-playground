set moduleName reduce_accum8_ii_is_1_Pipeline_1
set isTopModule 0
...
set C_modelName {reduce_accum8_ii_is_1_Pipeline_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ accum float 32 regular {array 8 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "accum", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ accum_address0 sc_out sc_lv 3 signal 0 } 
	{ accum_ce0 sc_out sc_logic 1 signal 0 } 
	{ accum_we0 sc_out sc_logic 1 signal 0 } 
	{ accum_d0 sc_out sc_lv 32 signal 0 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	accum { ap_memory {  { accum_address0 mem_address 1 3 }  { accum_ce0 mem_ce 1 1 }  { accum_we0 mem_we 1 1 }  { accum_d0 mem_din 1 32 } } }
}
